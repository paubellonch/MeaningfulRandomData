...
import numpy as np
import pandas as pd
from categorical_transforms import OneHotEncodingTransformer
...
class DataTransformer(object):
    ...
    def _fit_categorical(self, column_name, raw_column_data):
    ...
    def fit(self, raw_data, discrete_columns=tuple()):
        ...
        for column_name in raw_data.columns:
            ...
            if column_name in discrete_columns:
                column_transform_info = self._fit_categorical(
    ...
    def _transform_categorical(self, column_transform_info, raw_column_data):
    ...
    def transform(self, raw_data):
        ...
        for column_transform_info in self._column_transform_info_list:
            ...
            if column_transform_info.column_type == "continuous":
                ...
                column_data_list += self._transform_categorical(
                    column_transform_info, column_data)
    ...
    def _inverse_transform_categorical(self, column_transform_info, column_data):
        ohe = column_transform_info.transform
    ...
    def inverse_transform(self, data, sigmas=None):
        ...
        for column_transform_info in self._column_transform_info_list:
            ...
            if column_transform_info.column_type == 'continuous':
                ...
                assert column_transform_info.column_type == 'discrete'
                recovered_column_data = self._inverse_transform_categorical(column_transform_info, column_data)
